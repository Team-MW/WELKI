        ...
        <div className="fixed bottom-4 right-4 md:bottom-8 md:right-8 z-[100] transition-all duration-300 ease-out animate-bounce-subtle max-w-[95vw] md:max-w-none">
            <Link to="/contact" className="relative group block perspective-1000">
                ...
                <div className="relative p-[2px] rounded-2xl overflow-hidden bg-transparent transform transition-transform duration-300 group-hover:scale-105">
                    ...
                    <div className="relative bg-[#F59E0B] rounded-[14px] px-4 py-3 md:px-8 md:py-5 flex items-center gap-3 md:gap-6 overflow-hidden">
                        ...
                        <div className="relative z-10 w-10 h-10 md:w-14 md:h-14 rounded-xl flex items-center justify-center bg-gray-950 border border-gray-800 shadow-xl group-hover:border-white transition-colors duration-300">
                            ...
                            <FileCheck size={20} className="text-[#F59E0B] relative z-10 transition-colors duration-300 md:w-[28px] md:h-[28px]" strokeWidth={2.5} />
                        </div>

                        {/* Text Stack */}
                        <div className="relative z-10 flex flex-col min-w-[120px] md:min-w-[150px]">
                            <div className="flex items-center gap-2 mb-1">
                                <div className="w-1.5 h-1.5 rounded-full bg-gray-950 animate-ping"></div>
                                <span className="text-[8px] md:text-[10px] font-bold uppercase tracking-[0.2em] text-gray-950 drop-shadow-sm">
                                    Offre Spéciale
                                </span>
                            </div>
                            <span className="text-lg md:text-2xl font-black text-gray-950 transition-all duration-300 transform group-hover:translate-x-1">
                                Audit Gratuit
                            </span>
                        </div>
