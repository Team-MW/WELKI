    ...
    return (
        <Layout title="Accueil">
            <div className="bg-gray-950 min-h-screen text-white">
                ...
                <section className="relative min-h-[95vh] pt-20 md:pt-0 flex flex-col md:flex-row overflow-hidden bg-gray-950">

                    {/* Global Mobile Heading (Visible only on mobile/small screens) */}
                    <div className="md:hidden pt-24 pb-8 px-4 text-center bg-gray-950 z-10">
                        <h1 className="text-4xl font-black text-white mb-2">WELKI</h1>
                        <p className="text-xl text-gray-400 font-bold">Votre Expert Multi-Services</p>
                    </div>
                        ...
                        <div className="flex overflow-x-auto gap-6 pb-8 snap-x scrollbar-hide" id="reviews-container">
                            {[
                                ...
                                <motion.div
                                    ...
                                    className="min-w-[300px] md:min-w-[350px] bg-gray-900 p-8 rounded-3xl shadow-sm border border-gray-800 flex flex-col snap-center hover:shadow-md transition-shadow"
                                >
